    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-7 border-2 border-slate-200 hover:shadow-2xl transition-all duration-300">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-gray-600 mt-0.5">Filter by name or favorites</p>
        </div>
      </div>

      {/* Name Search */}
      <div className="mb-6">
        <label htmlFor="name-filter" className="block text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-14 pr-6 py-4 bg-gradient-to-br from-gray-50 to-blue-50/30 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-[#A4C639]/30 focus:border-[#A4C639] focus:bg-white transition-all duration-200 text-gray-900 font-medium placeholder:text-gray-400 shadow-sm hover:shadow-md"
            />
          ...
          <button
            ...
            className={`flex-1 px-6 py-4 rounded-xl text-sm font-bold transition-all duration-300 ${
              filterType === "favorites"
                ? "bg-gradient-to-r from-red-500 via-pink-500 to-rose-600 text-white shadow-lg shadow-red-500/30 scale-105"
                : "bg-slate-100 text-slate-700 hover:bg-slate-200 hover:scale-105 border-2 border-slate-200"
            }`}
          >
            <span className="flex items-center justify-center gap-2">
