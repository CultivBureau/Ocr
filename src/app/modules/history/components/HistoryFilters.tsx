    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-7 border-2 border-slate-200 hover:shadow-2xl transition-all duration-300">
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#4A7766]/10 to-[#3D6558]/10 rounded-xl blur-xl"></div>
          <div className="relative">
            <input
              type="text"
              id="name-filter"
              ...
              className={`w-full ${isRTL ? 'pr-14 pl-6' : 'pl-14 pr-6'} py-4 bg-gradient-to-br from-gray-50 to-[#4A7766]/5 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-[#4A7766]/30 focus:border-[#4A7766] focus:bg-white transition-all duration-200 text-gray-900 font-medium placeholder:text-gray-400 shadow-sm hover:shadow-md`}
              dir={dir}
            />
        ...
        <div className={`flex gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
          <button
            ...
            className={`flex-1 px-6 py-4 rounded-xl text-sm font-bold transition-all duration-300 ${
              filterType === "all"
                ? "bg-gradient-to-r from-[#4A7766] to-[#3D6558] text-white shadow-lg shadow-[#4A7766]/30 scale-105"
