      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scaleIn">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-gradient-to-br from-[#4A7766] to-emerald-500 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-600 mt-0.5">
                Share <span className="font-bold text-[#4A7766]">{documentTitle}</span> with others
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-5 py-4 bg-gradient-to-br from-gray-50 to-blue-50/30 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-[#4A7766]/30 focus:border-[#4A7766] focus:bg-white transition-all duration-200 text-gray-900 font-medium placeholder:text-gray-400 shadow-sm hover:shadow-md"
              placeholder="email1@example.com, email2@example.com"
            />
            <p className="mt-2 text-xs font-medium text-gray-600 flex items-center gap-1">
              <svg className="w-3 h-3 text-[#4A7766]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mb-6 p-4 bg-gradient-to-br from-blue-50/50 to-indigo-50/30 rounded-xl border border-blue-200/50">
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 text-[#4A7766] border-2 border-gray-300 rounded focus:ring-2 focus:ring-[#4A7766]/30 focus:border-[#4A7766] transition-all cursor-pointer"
              />
              <div>
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 px-5 py-3.5 bg-gradient-to-r from-[#4A7766] to-emerald-500 text-white font-bold rounded-xl hover:from-[#8FB02E] hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-95"
            >
              {isLoading ? (
