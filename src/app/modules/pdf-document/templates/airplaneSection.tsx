  ...
  return (
    ...
    >
      ...
      {showNotice && defaultNotice && (
        <div className="mt-5">
          <div className={`flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl px-5 py-4 ${direction === 'rtl' ? 'flex-row-reverse border-r-4 border-r-[#DC143C]' : 'border-l-4 border-l-[#DC143C]'}`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
            ...
            <p className="text-[#DC143C] font-semibold text-sm md:text-base leading-relaxed">
              {defaultNotice}
            </p>
          </div>
        </div>
