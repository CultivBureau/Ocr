...
import { uploadFile, extractStructured } from "@/app/modules/pdf-document/services/PdfApi";
import type { UploadResponse, ExtractResponse, SeparatedStructure } from "@/app/modules/pdf-document/types/ExtractTypes";
